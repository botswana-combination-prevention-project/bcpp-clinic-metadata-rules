"""
Django settings for bcpp_clinic_metadata_rules project.
...
ROOT_URLCONF = 'bcpp_clinic_metadata_rules.urls'
...
WSGI_APPLICATION = 'bcpp_clinic_metadata_rules.wsgi.application'
